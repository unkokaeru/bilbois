...
cheatSheetName = moduleCode + " " + moduleName + " Cheat Sheet"

await tp.file.rename(cheatSheetName)
-%>
...
**Small warning**: the following makes the most sense if you read it all first. It also assumes you have knowledge from ...

### Possible Question Topics and their Explanations

#### 0. Useful "Known" Facts & Common Results
