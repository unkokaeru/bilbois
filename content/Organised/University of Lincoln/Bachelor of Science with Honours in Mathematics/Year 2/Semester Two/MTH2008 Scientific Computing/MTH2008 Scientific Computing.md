...
- ~~**Coursework** 1 (20%)~~ *Achieved 95%, unclear question*.
- **Coursework** 2 (20%).
- ~~Portfolio **Test** 1 (20%)~~ *Achieved 100%, could've been done quicker*.
- Portfolio **Test** 2 (20%).
- ~~Logbook 1 (10%~~) *Achieved 93%, didn't mention my extensive C++ background*.
- Logbook 2 (10%).
...
- [[MTH2008 Scientific Computing Cheat Sheets]]
- [[MTH2008 Scientific Computing Practice Tests]]
- [[MTH2008 Scientific Computing Flashcards]]
