...
**Attendance**:
- [x] Katie Arnold (**27620935**)
- [x] William Fayers (**27378661**)
- [x] Torin (**26424071**)
- [x] Tom Ward (**26479576**)
...
- Discussed recurrence relations within Bessel functions (*which only explain relationships between three functions, not what each function actually is - their existence is also not fully understood; they're just embedded in the mathematics, even if you start with wrong values and work down then you can get better values, e.g. $100\to5$ for significant precision*).
- Discussed types (e.g. first and second type): $J$ and $Y$ are some main types, but there are also spherical Bessel functions (*sort of like siblings, relates to quantum physics also, like with Schrödinger equation*) and others.
...
![[../../../../../../Auto-Generated/Attachments/330px-Vibrating_drum_Bessel_function.gif]]
...
Source 2 PDF: [M. Abramowitz and I. Stegun, Handbook of Mathematical Functions - BESSEL FUNCTIONS ONLY.pdf](https://universityoflincoln.sharepoint.com/:b:/r/sites/BesselFunctions/Shared%20Documents/_Resources/M.%20Abramowitz%20and%20I.%20Stegun,%20Handbook%20of%20Mathematical%20Functions%20-%20BESSEL%20FUNCTIONS%20ONLY.pdf?csf=1&web=1&e=LRdhp5).