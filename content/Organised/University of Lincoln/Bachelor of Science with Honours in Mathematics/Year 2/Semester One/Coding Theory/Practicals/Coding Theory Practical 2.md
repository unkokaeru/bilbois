...
We can explain why $C$ can detect up to four errors by using the [[../Definitions/Definition of Distance Theorem|Definition of Distance Theorem]]. The minimum distance $d_{\text{min}}(C)=5$, by inspection, hence
$$
5\ge t+1\iff t\le 4
$$
...
Similarly, given that $d_{\text{min}}(C)=5$, we can use the [[../Definitions/Definition of Distance Theorem|Definition of Distance Theorem]] to explain why $C$ can correct up to two errors:
$$
5\ge2k+1\iff k\le 2
$$
...
Given that we have to detect up to $5$ errors, we can use the [[../Definitions/Definition of Distance Theorem|Definition of Distance Theorem]] to find the minimal distance $d_{\text{min}}(C)$ required:
$$
...
Similarly, given that we have to correct up to $3$ errors, we can use the [[../Definitions/Definition of Distance Theorem|Definition of Distance Theorem]] to find the minimal distance $d_{\text{min}}(C)$ required:
$$
...
We can show that the code detects two errors and corrects one error with the [[../Definitions/Definition of Distance Theorem|Definition of Distance Theorem]]:
