Alternative forms: [[Coding Theory Coursework.pdf]] and [[Coursework/Coding Theory Coursework.docx]].
...
We can then find the minimal distance $d_\text{min}(C)$ of the code $C$ and use it to determine how many errors it can detect/correct with the [[../Definitions/Definition of Distance Theorem|Definition of Distance Theorem]]:
...
To determine how many errors $C$ can detect and correct we can use the [[../Definitions/Definition of Distance Theorem|Definition of Distance Theorem]]:
...
Given a space of words of length four, over the alphabet used to build $C$, we can calculate the **volume of a solid sphere of radius $2$ and centre $\downarrow\searrow\rightarrow p$**, i.e. $S_{2}(\downarrow\searrow\rightarrow p)$, by using the [[../Definitions/Definition of the Volume of a Solid Hamming Distance Sphere]]:
...
We can prove that **Hamming's original code is perfect** by using the [[../Definitions/Definition of a Perfect Code in Coding Theory]]:
...
Then the code is perfect. Hence, using the [[../Definitions/Definition of the Volume of a Solid Hamming Distance Sphere]] and given that the parameters of Hamming's original code are $n=7,M=16,d=3,q=2$,
