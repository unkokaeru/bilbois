...
5. **Code Rate**:
    ...
    2. Calculated as the ratio of the number of information symbols $k$ to the length of codewords $n$: $R = \frac{k}{n}$. Alternatively, the parity symbols $r$ with the length: $R= \frac{n-r}{n}$.
